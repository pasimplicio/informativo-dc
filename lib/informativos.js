...
export const CONTATOS = [
  { id: 'arrecadacao',    nome: 'Arrecadação',       inicial: 'AR', horarios: '17h' },
  // id continua 'faturamento': e a chave usada pelo WF4-INFO no /api/publicar.
  // Trocar o id quebraria a publicacao; o nome e so rotulo de tela.
  { id: 'faturamento',    nome: 'Faturas × Pagamentos', inicial: 'FP', horarios: '22h' },
  { id: 'cortes',         nome: 'Cortes',            inicial: 'CO', horarios: '21h' },
  { id: 'ordens',         nome: 'Ordens de Serviço', inicial: 'OS', horarios: '20h' },
  { id: 'hidrometracao',  nome: 'Hidrometração',     inicial: 'HD', horarios: '19h30' },
];
